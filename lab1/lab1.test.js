...
//Test case that illegal or edge case
// console.log(lab1.questionOne([5, -2, -1]));  // Returns and then outputs [true, true, false]
...
// console.log(lab1.questionTwo(2, 10, 4.1)); //Returns and then outputs 2222
...
// console.log();
// console.log(lab1.questionFour("Helllllllo, class!", "l")); // Returns and then outputs 3

//test case that provided in the assignments
